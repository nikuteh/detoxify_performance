...
python -u scripts/community/visualization/plot_toxic_comment_volume_over_time.py \
  ...
  --combined-line-output "${VIS_DIR}/${COMMENTS_BASE}_comment_and_toxic_comment_volume_by_month_line.png" \
  ...
  --combined-line-title "${SUBREDDIT} Comment and Toxic Comment Volume by Month" \
  --threshold "$THRESHOLD" \
